...
public static class DataSeed
{
    public static IServiceCollection AddDataSeed(this IServiceCollection services)
    {
        ...
        // [
        //     new() { OptionKey = 1, FilePath = @"~/wwwroot/images/boules.jpg" },
        //     new() { OptionKey = 2, FilePath = @"~/wwwroot/images/datena.jpeg" },
        //     new() { OptionKey = 3, FilePath = @"~/wwwroot/images/instala_drive.jpg" },
        //     new() { OptionKey = 4, FilePath = @"~/wwwroot/images/marina.jpg" },
        //     new() { OptionKey = 5, FilePath = @"~/wwwroot/images/ricardo_nunes_piscina.jpg" },
        //     new() { OptionKey = 6, FilePath = @"~/wwwroot/images/tabatha_amaral.jpg" },
        // ];
        //
